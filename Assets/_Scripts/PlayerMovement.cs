...
public class PlayerMovement : MonoBehaviour {
    ...
    // Updated input
    [SerializeField]
    InputActionReference move, jump, look, crouch;
    void OnEnable()
    {
        // jump.action.started += ()
    }
    ...
    private void Look() {
        ...
        float mouseX = mouseInput.x * sensitivity * Time.fixedDeltaTime * sensMultiplier;
        float mouseY = mouseInput.y * sensitivity * Time.fixedDeltaTime * sensMultiplier;
